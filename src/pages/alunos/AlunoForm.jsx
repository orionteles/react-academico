...
const AlunoForm = (props) => {
  ...
  function enviarDados(data) {
    ...
    const resultado = dados.id ? AlunoService.update(dados.id, data) : AlunoService.create(data)
        ...
        <Row>
          <Col sm={6}>
            <Card>
              ...
              <Card.Body>
                ...
                <Input label="Matrícula" name="matricula" reference={reference} valor={dados.matricula} />
                <Input label="E-mail" name="email" reference={reference} valor={dados.email} />
          ...
          <Col sm={6}>
            <Card>
              ...
              <Card.Body>
                <Input label="CEP" name="cep" reference={reference} labelWidth={4} valor={dados.cep} mask="99.999-999" />
